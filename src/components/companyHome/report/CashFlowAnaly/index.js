      ...
      <LoanDemo type="new"/>
        <div>
          ...
          <div className={styles.analysisContent}>
            ...
            <p className={styles.formula}>
              <span className={styles.point} />
              <span className={styles.formulaFonts}>现金债务总额比</span>
            </p>
            ...
            <p className={styles.formula}>
              <span className={styles.point} />
              <span className={styles.formulaFonts}>现金满足投资比率</span>
            </p>
            <p className={styles.content}>反映经营活动现金满足主要现金需求的程度，用于衡量企业维持或扩大生产经营规模的能力，比率越大，资金自给率越高。</p>
              <p className={styles.line} />
              <p className={styles.formula}>
                <span className={styles.point} />
                <span className={styles.formulaFonts}>现金营运指数</span>
              </p>
