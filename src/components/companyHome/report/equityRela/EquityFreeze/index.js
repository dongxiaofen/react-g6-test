  ...
  const data = {
    meta: {
      body: [
        ...
        { 'key': 'unfreOrgName', 'width': '4', 'hide': true, 'noValueNoShow': true },
        { 'key': 'unfreDocId', 'width': '4', 'hide': true, 'noValueNoShow': true },
        { 'key': 'unfreDate', 'width': '4', 'hide': true, 'noValueNoShow': true },
        { 'key': 'unfreInfo', 'width': '4', 'hide': true, 'noValueNoShow': true },
      ],
