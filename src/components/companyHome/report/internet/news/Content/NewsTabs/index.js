...
function NewsTabs({internetStore, uiStore, routing}) {
  ...
  const tabData = [
    {label: '全部新闻', key: 'ALL'},
    {label: '企业战略', key: 'NEWS_STRATEGY'},
    {label: '诉讼纠纷', key: 'NEWS_LITIGATION'},
    {label: '经营状况', key: 'NEWS_BUSINESS'},
    {label: '品牌产品', key: 'NEWS_BRAND'},
    {label: '人事变动', key: 'NEWS_PERSONNEL'},
    {label: '其他新闻', key: 'NEWS_OTHER'},
  ];
  return (
