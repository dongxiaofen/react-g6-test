    ...
    <div>
      {
        judgeIsModuleExist('TEAM_RECRUITMENT_RESUME')
          ...
          <div>
            ...
            <EmployeeMessage moduleData={pathval.getPathValue(pdfStore, 'team.recruitmentStatisticResponse.categoryInfo')} />
            <EmployeeDegreeInfo moduleData={pathval.getPathValue(pdfStore, 'team.recruitmentStatisticResponse.degreeInfo')} />
            <EmployeeSalaryDis moduleData={pathval.getPathValue(pdfStore, 'team.recruitmentStatisticResponse.salaryDis')} />
            <EmployeeSchoolInfo moduleData={pathval.getPathValue(pdfStore, 'team.recruitmentStatisticResponse.schoolInfo')} />
            <EmployeeCategoryTypeInfo moduleData={pathval.getPathValue(pdfStore, 'team.recruitmentStatisticResponse.majorInfo')} />
            <EmployeeList moduleData={pathval.getPathValue(pdfStore, 'team.recruitmentInfo.data')} />
          </div>
          :
          ''
      }
