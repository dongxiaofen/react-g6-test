...
function SubAccount({ accountProfileStore }) {
  ...
  const warningCompnay = {
    ...
    error: accountProfileStore.subWarningCompnay.errorCode || accountProfileStore.subWarningCompnay.data.length === 0,
  ...
  const riskCompnay = {
    ...
    error: accountProfileStore.subHighRisk.errorCode || accountProfileStore.subHighRisk.length === 0,
  ...
  const lowScoreCompnay = {
    ...
    error: accountProfileStore.subLowestScore.errorCode || accountProfileStore.subLowestScore.data.length === 0,
    errCategory: 3,
