...
function ErrorText({module, error, errCategory = 0, height, errorWords, path}) {
  const dict = {
    ...
    '我的账号最新预警企业（已创建）': '您还未创建监控，请前往搜索进行创建',
    '我的账号最新预警企业（未创建）': '您监控的企业尚未触发预警，如需查看预警规则，请访问预警设置',
    '我的账号预警企业排名（已创建）': '您还未创建监控，请前往搜索进行创建',
    '我的账号预警企业排名（未创建）': '您监控的企业尚未触发预警，如需查看预警规则，请访问预警设置',
    '子账号最新预警企业（有子账号）': '您下属子账号未创建分析',
